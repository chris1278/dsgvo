...
class permission extends \phpbb\db\migration\migration
{
	...
	{
		return [
			['permission.add', ['u_dsgvo_overview']],
				['permission.permission_set', ['ADMINISTRATORS', 'u_dsgvo_overview', 'group']],
				['permission.permission_set', ['GLOBAL_MODERATORS', 'u_dsgvo_overview', 'group']],
				['permission.permission_set', ['REGISTERED', 'u_dsgvo_overview', 'group']],
				['permission.permission_set', ['REGISTERED_COPPA', 'u_dsgvo_overview', 'group']],
				['permission.permission_set', ['NEWLY_REGISTERED', 'u_dsgvo_overview', 'group']],
